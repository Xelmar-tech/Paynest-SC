...
/// @title AddressRegistryV1
/// @notice A simple, global contract that manages username-to-address mappings for the PayNest ecosystem
/// @dev Implements the IRegistryV1 interface and provides basic username claiming and address resolution functionality
contract AddressRegistryV1 is IRegistryV1 {
