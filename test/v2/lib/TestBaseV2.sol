...
import {ALICE_ADDRESS, BOB_ADDRESS, CAROL_ADDRESS, DAVID_ADDRESS} from "../../v1/lib/constants.sol";
import {Test} from "forge-std/Test.sol";

contract TestBaseV2 is Test {
    // Convenience actors for testing (reuse V1 constants)
